...
| T-ITEM-1 | **"Remains of the dead" lootable body item** — looting a corpse yields a `REMAINS` item ("Remains of R4 Plague Marine — Morvax") that opens the dead model's overview and can be traded/sold/offered at doors | 🔥 engine + canon | `in-progress` | spoils · sess:f1b48505-664e-4f0a-8887-19ba14493281 | 2026-07-24 | **DESIGN LOCKED 2026-07-24** — full spec `docs/superpowers/specs/2026-07-24-capture-remains-design.md` (build as ONE slice with T-MISC-1: aftermath-only looting, body-takes-a-slot, possession-owns-the-revival-clock, auto-recover own dead). Feeds the corpse-consuming faction doors via a generic `accepts: REMAINS` hook. |
| T-MISC-1 | **Subdue / Capture mechanic** — non-lethal takedown → a `CAPTIVE` item (living cousin of Remains); tradeable/usable at doors | 🔥 engine + canon | `in-progress` | spoils · sess:f1b48505-664e-4f0a-8887-19ba14493281 | 2026-07-24 | **DESIGN LOCKED 2026-07-24** — full spec `docs/superpowers/specs/2026-07-24-capture-remains-design.md` (build as ONE slice with T-ITEM-1). Non-Lethal weapon tag + tiered Capture item tag (3/2/1 AP), gate = exactly 1 wound, standing action, captive carried in an empty slot, full fate menu (ransom/sell/execute/release), PCs capturable. Powers Drukhari Slave Raid, GSC Gene-Harvest, Astartes rescue. |
