...
| T-GX-G3 | Author **Obscurus** segmentum | canon + tests | `claimed` | galaxy · sess:406f1b0a-8f6e-4674-95ec-6d43178f11bd | 2026-07-20 | Reserved. **Prepping offline (scratchpad) — NOT holding the canon lane** (G2/pacificus holds it). Will seize the lane + inject only after G2 → `ready-to-push`. Folds in demo sectors Vigilus/Pallid/Kraith unchanged. |
