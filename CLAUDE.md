...
**Current state:** engine **v18** (+ flywheel/territory + capture/remains + missions + combat conditions), canon **data v1.22** — deployed and running. The full galaxy is minted (v1.12–v1.16): **5 segmentums · 27 sectors · 87 planets · 287 walkable locations · all 20 factions homed**.
